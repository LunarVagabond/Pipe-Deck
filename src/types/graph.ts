 ...
 * `reverb_delay`, `limiter`, and `stereo_widener` graduated to real
 * `delay`/`limiter`/`widener` processing nodes (issues #313/#311/#314), the
 * same way `eq5band` graduated out of this list previously. */
