...
async function onAddNodeAction(type: "output" | "input" | "fan_out" | "mixer" | "eq5band" | "delay" | "limiter" | "pan") {
  contextMenu.value = null;
  if (type === "fan_out" || type === "mixer" || type === "eq5band" || type === "delay" || type === "limiter" || type === "pan") {
    const defaultLabel =
      type === "fan_out"
        ? "Fan-Out"
        : type === "mixer"
