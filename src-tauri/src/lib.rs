...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::routing::add_connection_effect,
            commands::routing::remove_connection_effect,
            commands::routing::set_connection_volume,
            commands::routing::set_connection_mute,
